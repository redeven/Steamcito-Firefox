(async () => {
  ...
  function showCart() {
    ...
    let newCart = `<div class="estimated_total_extension">
  ...
  function showTaxes() {
    ...
    let taxesContainer = `<div class="tax-container">
    ...
    function showFullInfo(tax, type) {
      ...
      if (type == 'national') {
        document
          .querySelector('.tax-container ul.impuestos-nacionales')
          .insertAdjacentHTML('afterbegin', DOMPurify.sanitize(taxList));
      } else {
        document
          .querySelector('.tax-container ul.impuestos-provinciales')
          .insertAdjacentHTML('afterbegin', DOMPurify.sanitize(taxList));
      }
    }
  }
